 ...
 * @LastEditTime: 2020-12-31 23:48:34
...
export default function Author(props) {
  ...
  return (
    <div className="auth">
      ...
      <div className="msg">
        {/* <h3>
          昵称：<span>{props.authorInfo.name}</span>
        </h3>
        <h3>
          码龄：<span>{props.authorInfo.codeAge}</span>年
        </h3>
        <h3>
          身份：<span>{props.authorInfo.identity}</span>
        </h3> */}
        {/* <h3>
          技术栈：
        ...
        {/* </h3> */}
        {/* <h3>
          QQ：<span>{props.authorInfo.qq}</span>
        </h3>

        <h3>
          邮箱：<span>{props.authorInfo.email}</span>
        </h3> */}
